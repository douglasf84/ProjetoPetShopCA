...
namespace CleanArchBase.Infra.Data.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DataAtualizacaoEstoque = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DataCriacao = table.Column<DateTime>(type: "datetime2", maxLength: 20, nullable: false),
                    DataUltimaAtualizacao = table.Column<DateTime>(type: "datetime2", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Categorias_Marcas_MarcaId",
                        column: x => x.MarcaId,
